...
import { Activity, Lock, User, UserPlus, ArrowLeft, Eye, EyeOff, CheckCircle2 } from "lucide-react";
      ...
      <div className="min-h-screen flex bg-bg">
        <div className="hidden lg:flex lg:w-[55%] flex-col justify-between p-12 relative overflow-hidden">
          ...
          <div className="relative flex-1 flex flex-col justify-center max-w-md">
            ...
            <p className="text-sm text-slate-400 text-center leading-relaxed mb-6">
              您的账号已提交, 状态为 <span className="text-accent-glow font-semibold">待审批</span>。<br />
        ...
        <div className="flex-1 flex items-center justify-center p-6 relative">
          ...
          <div className="w-full max-w-sm glass shadow-card p-8">
            ...
            <div className="bg-slate-800/60 rounded-xl p-4 text-xs text-slate-400 mb-6 border border-border">
              ⚠️ 账号状态: <b className="text-accent-glow">待审批</b> — 管理员审批通过后方可登录交易。
            </div>
            <button
              onClick={() => nav("/login")}
    ...
    <div className="min-h-screen flex bg-bg">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-sm glass shadow-card p-8">
          ...
          <div className="mt-4 p-3 rounded-xl bg-accent/10 border border-accent/20 text-xs text-accent-glow/80">
            ⚠️ 注册后账号为 <b className="text-accent-glow">待审批</b> 状态, 管理员审批通过后方可登录交易。
          </div>
          ...
          <div className="text-center mt-4">
            <a
              href="/login"
              onClick={goLogin}
              className="text-sm text-accent-glow hover:text-accent transition font-medium inline-flex items-center gap-1 cursor-pointer"
            >
