...
from sqlalchemy import Numeric, Boolean, Date, DateTime, ForeignKey, Integer, String, Text, UniqueConstraint
...
class EquitySnapshot(Base, TimestampMixin):
    ...
    equity: Mapped[float] = mapped_column(Numeric)  # 账户权益(USDT)
    balance: Mapped[float] = mapped_column(Numeric)  # 余额
