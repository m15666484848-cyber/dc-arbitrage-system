...
from sqlalchemy import Numeric, DateTime, ForeignKey, Integer, String, Text
...
class PendingOrder(Base, TimestampMixin):
    ...
    entry_price: Mapped[float] = mapped_column(Numeric)  # 目标入场价
    ...
    notional_usdt: Mapped[float] = mapped_column(Numeric)  # 名义价值
